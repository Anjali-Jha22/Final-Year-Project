...
__all__ = [
    ...
    'SpObjectTokenCategory', 'SECFIgnoreCase',
    'DISPIDSPTSI_ActiveLength', 'SDA_Consume_Leading_Spaces',
    'DISPID_SGRSTransitions', 'SDA_No_Trailing_Space',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRCEAdaptation',
    'SAFT16kHz8BitStereo', 'SpeechDictationTopicSpelling',
    'SAFTADPCM_22kHzStereo', 'ISpeechAudioBufferInfo',
    'SpeechEngineConfidence', 'SAFT48kHz16BitStereo',
    'eLEXTYPE_PRIVATE14', 'DISPID_SDKSetStringValue',
    'SRSInactiveWithPurge', 'SP_VISEME_13', 'SPLO_DYNAMIC',
    'ISpNotifyTranslator', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SRAudioInputStream', 'SRTStandard', 'SVP_5',
    'SpeechAudioProperties', 'DISPID_SDKGetlongValue', 'SLTApp',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPRST_INACTIVE_WITH_PURGE',
    'SGRSTTWildcard', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPFM_CREATE', 'DISPID_SRRTimes', 'SpeechPartOfSpeech',
    'DISPID_SPAStartElementInResult', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SRGDictationUnload', 'DISPID_SRCEEnginePrivate',
    'DISPID_SOTId', 'SRADynamic', 'SPPS_Modifier',
    'DISPID_SRCERecognizerStateChange', 'ISpPhrase',
    'DISPID_SRRecognizer', 'SITooFast', 'DISPID_SRCRecognizer',
    'SP_VISEME_11', 'SPSHT_OTHER', 'SPSHORTCUTPAIRLIST',
    'DISPID_SAVolume', 'DISPID_SpeechRecoContextEvents',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPPS_LMA',
    'DISPID_SRSetPropertyNumber', 'DISPID_SVSLastBookmark',
    'DISPID_SPIGrammarId', 'SVEBookmark', 'SSSPTRelativeToStart',
    'ISpeechLexicon', 'SVP_3', 'SVEAllEvents',
    'SPADAPTATIONRELEVANCE', 'SAFTADPCM_11kHzMono', 'SVF_Emphasis',
    'SGRSTTRule', 'DISPID_SLGenerationId', 'SPINTERFERENCE_NOISE',
    'DISPID_SPERetainedStreamOffset', 'SRATopLevel',
    'SAFTGSM610_11kHzMono', 'SpeechRecoProfileProperties',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SDKSetBinaryValue',
    'DISPID_SpeechDataKey', 'SpeechTokenContext',
    'SAFT32kHz16BitStereo', 'SPCS_DISABLED',
    'DISPID_SOTGetDescription', 'ISpeechDataKey',
    'DISPID_SpeechLexiconWord', 'SPBO_TIME_UNITS',
    'DISPID_SpeechMMSysAudio', 'SDTRule', 'SAFT48kHz8BitStereo',
    'DISPID_SPPsItem', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SLGetPronunciations', 'SPINTERFERENCE',
    'DISPID_SLPs_NewEnum', 'SSTTTextBuffer',
    'SAFTCCITT_uLaw_44kHzMono', 'SAFT12kHz16BitMono',
    'DISPID_SRIsUISupported', 'SREStreamEnd', 'DISPID_SLPLangId',
    'SECFDefault', 'SpCustomStream', 'DISPID_SRSClsidEngine',
    'eLEXTYPE_PRIVATE3', 'SAFT22kHz16BitMono',
    'ISpeechPhraseProperty', 'ISpEventSource',
    'DISPID_SRCEHypothesis', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SLPPhoneIds', 'DISPID_SPAPhraseInfo',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPCPhoneToId',
    'SPVOICESTATUS', 'SVP_13', 'SpeechRecognitionType',
    'SAFT32kHz8BitMono', 'DISPID_SRCEInterference',
    'SpeechRecoEvents', 'STSF_LocalAppData',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SGRSAddSpecialTransition',
    'SpeechRetainedAudioOptions',
    'SpeechPropertyLowConfidenceThreshold', 'SPXMLRESULTOPTIONS',
    'DISPID_SPIStartTime', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SVSCurrentStreamNumber',
    'SAFTADPCM_44kHzMono', 'DISPID_SPRuleParent', 'SPEI_PHRASE_START',
    'SVSFIsFilename', 'DISPID_SRRTLength', 'eLEXTYPE_RESERVED6',
    'DISPID_SpeechVoice', 'SpeechRuleState',
    'ISpeechLexiconPronunciation', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SLAddPronunciation', 'DISPID_SpeechCustomStream',
    'SpeechVisemeType', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SVAudioOutputStream', 'DISPID_SpeechVoiceEvent',
    'DISPID_SpeechGrammarRuleState', 'ISequentialStream',
    'DISPID_SRSSupportedLanguages', 'SpeechVoicePriority',
    'SPPS_RESERVED4', 'DISPID_SpeechGrammarRule',
    'ISpObjectWithToken', 'SITooLoud', 'SVSFlagsAsync',
    'DISPID_SRGDictationSetState', 'ISpeechRecoResultDispatch',
    'DISPID_SPIProperties', 'SPPARTOFSPEECH',
    'DISPID_SDKGetBinaryValue', 'DISPID_SRGetPropertyString',
    'SGRSTTWord', 'DISPID_SPIElements', 'eLEXTYPE_PRIVATE13',
    'DISPID_SVEPhoneme', 'SPLO_STATIC', 'DISPID_SPEAudioTimeOffset',
    'ISpRecoGrammar', 'ISpeechLexiconWord', 'DISPID_SVEAudioLevel',
    'SREInterference', 'SAFTADPCM_11kHzStereo', 'SpeechLoadOption',
    'IStream', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SAStatus', 'SSFMOpenForRead', 'SPEI_VOICE_CHANGE',
    'DISPID_SASCurrentSeekPosition', 'SDTProperty',
    'ISpeechAudioStatus', 'DISPID_SOTCGetDataKey',
    'SAFT32kHz16BitMono', 'SpResourceManager', 'SVESentenceBoundary',
    'ISpPhraseAlt', 'DISPID_SVSRunningState', 'SVSFIsNotXML',
    'SPAO_RETAIN_AUDIO', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SDKCreateKey', 'DISPID_SPPBRestorePhraseFromMemory',
    'ISpeechLexiconPronunciations', 'DISPID_SGRSTsItem', 'tagSTATSTG',
    'SAFTCCITT_uLaw_22kHzMono', 'SPRULESTATE',
    'DISPID_SGRSAddRuleTransition', 'ISpRecognizer3',
    'SWPUnknownWordUnpronounceable', 'SPWF_SRENGINE',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechPhraseElements',
    'SPEI_SR_PRIVATE', 'SPCS_ENABLED', 'SP_VISEME_8',
    'DISPID_SLWs_NewEnum', 'SVP_18', 'SPVPRI_OVER',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPVPRIORITY', 'ISpRecoResult',
    'SPCONTEXTSTATE', 'DISPID_SVEViseme', 'SPEI_RECO_STATE_CHANGE',
    'SPGRAMMARSTATE', 'DISPID_SPIEngineId', 'DISPID_SRIsShared',
    'SPSHT_NotOverriden', 'SP_VISEME_21', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SLPSymbolic',
    'SPFM_OPEN_READONLY', 'SAFT24kHz16BitStereo',
    'DISPID_SpeechLexicon', 'SWTDeleted', 'SpStream',
    'SAFT44kHz8BitStereo', 'DISPID_SGRInitialState', 'SVPAlert',
    'SREBookmark', 'SpeechSpecialTransitionType',
    'DISPID_SVDisplayUI', 'SECFNoSpecialChars',
    'DISPID_SPEActualConfidence', 'DISPID_SRCreateRecoContext',
    'DISPID_SRCESoundStart', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SpeechAudio', 'DISPID_SPIAudioSizeBytes',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SMSADeviceId',
    'DISPID_SRGState', 'DISPID_SOTIsUISupported',
    'DISPID_SpeechRecognizerStatus', 'SPDKL_LocalMachine',
    'DISPID_SLAddPronunciationByPhoneIds', '__MIDL_IWinTypes_0009',
    'SAFT11kHz8BitStereo', 'SpeechAudioState', 'SRAExport',
    'SPEI_START_SR_STREAM', 'DISPID_SPPNumberOfElements',
    'SpeechCategoryPhoneConverters', 'DISPID_SRCCreateGrammar',
    'SpeechVoiceSpeakFlags', 'SGRSTTDictation',
    'ISpeechPhraseInfoBuilder', 'SPSERIALIZEDPHRASE',
    'DISPID_SVEEnginePrivate', 'DISPID_SRCPause', 'SVP_16',
    'SP_VISEME_14', 'DISPID_SWFEChannels', 'SpeechDisplayAttributes',
    'SVSFUnusedFlags', 'ISpeechRecoResultTimes', 'SPEI_SOUND_END',
    'eLEXTYPE_PRIVATE17', 'DISPID_SPELexicalForm',
    'SPWORDPRONUNCIATION', 'SGLexical', 'ISpResourceManager',
    'ISpeechLexiconWords', 'SRSEIsSpeaking',
    'DISPIDSPTSI_SelectionLength', 'SPGS_DISABLED',
    'SpeechDataKeyLocation', 'DISPID_SVSLastStreamNumberQueued',
    'SPPS_RESERVED1', 'DISPID_SRCERequestUI', 'SDTLexicalForm',
    'DISPID_SPEs_NewEnum', 'SAFTADPCM_44kHzStereo',
    'SAFT16kHz16BitMono', 'eLEXTYPE_USER', 'SpNullPhoneConverter',
    'SpNotifyTranslator', 'SPEI_MIN_SR', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRSAudioStatus', 'ISpLexicon', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SPRNumberOfElements', 'DISPID_SVGetProfiles', 'SVP_1',
    'DISPID_SOTCreateInstance', 'ISpeechRecognizer', 'SBOPause',
    'DISPID_SPAsItem', 'SPEI_MIN_TTS', 'DISPID_SPRs_NewEnum',
    'SPWF_INPUT', 'DISPID_SRState', 'STCAll',
    'DISPID_SRSetPropertyString', 'SPINTERFERENCE_NOSIGNAL',
    'SPSEMANTICFORMAT', 'SPPS_Noncontent', 'DISPID_SPIGetText',
    'SRTSMLTimeout', 'eLEXTYPE_RESERVED8', 'ISpRecoCategory',
    'DISPID_SOTCSetId', 'DISPID_SGRClear',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpFileStream', 'SPGRAMMARWORDTYPE',
    'SAFTText', 'SPPS_NotOverriden', 'SAFT22kHz8BitMono',
    'SPWT_PRONUNCIATION', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPPHRASE', 'DISPID_SRGReset', 'DISPID_SGRs_NewEnum',
    'DISPID_SRCSetAdaptationData', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPAS_RUN', 'LONG_PTR', 'SPEI_SOUND_START', 'DISPID_SOTsItem',
    'STSF_AppData', 'DISPID_SpeechPhraseElements', 'DISPID_SPRsItem',
    'DISPID_SPPsCount', 'SpeechWordType', 'IEnumString',
    'eLEXTYPE_PRIVATE12', 'DISPID_SVSkip', 'SVPNormal',
    'ISpeechPhraseReplacements', 'DISPID_SRCCmdMaxAlternates',
    'SVSFNLPMask', 'ISpShortcut', 'ISpNotifySource', 'SPAR_Unknown',
    'SPBO_AHEAD', 'SSTTDictation', 'SpAudioFormat',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SDKLCurrentConfig',
    '_SPAUDIOSTATE', 'SPSSuppressWord', 'DISPID_SGRSTPropertyValue',
    'SpShortcut', 'SVSFParseAutodetect', 'SPDKL_DefaultLocation',
    'DISPID_SDKOpenKey', 'SpeechRecoContextState', 'SPCT_SLEEP',
    'DISPID_SpeechPhraseReplacement', 'ISpeechGrammarRuleState',
    'DISPID_SVSpeakCompleteEvent', 'eLEXTYPE_VENDORLEXICON',
    'eWORDTYPE_DELETED', 'DISPID_SRCEAudioLevel', 'SPSVerb',
    'DISPID_SpeechPhraseAlternate', 'SGDSActiveWithAutoPause',
    'SAFT8kHz16BitStereo', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SPPFirstElement', 'eLEXTYPE_PRIVATE8', 'DISPID_SGRSTText',
    'ISpeechMMSysAudio', 'eLEXTYPE_PRIVATE6', 'DISPID_SGRsCount',
    'DISPID_SLWLangId', 'SAFT11kHz16BitStereo', 'ISpeechAudioFormat',
    'SpeechAudioFormatType', 'SPEI_TTS_PRIVATE', 'SPRS_ACTIVE',
    'SpMemoryStream', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SVSLastBookmarkId', 'SPEI_SR_BOOKMARK',
    'DISPID_SGRSAddWordTransition', 'SpeechTokenKeyAttributes',
    'SPXRO_SML', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVEventInterests', 'SITooSlow', 'DISPID_SRProfile',
    'SAFT44kHz8BitMono', 'SPEVENT', 'DISPID_SPRuleConfidence',
    'SAFTCCITT_uLaw_8kHzStereo', 'SP_VISEME_1', 'DISPID_SPRuleName',
    'DISPID_SABIMinNotification', 'DISPID_SGRSTType',
    'SAFT8kHz8BitMono', 'SPPS_RESERVED2', 'ISpeechRecognizerStatus',
    'SVSFPurgeBeforeSpeak', 'SPEI_MAX_SR',
    'DISPID_SREmulateRecognition', 'SpeechCategoryVoices',
    'SAFT12kHz8BitStereo', 'DISPID_SGRsCommit', 'SVF_None',
    'SAFTCCITT_ALaw_11kHzMono', 'SpeechStreamSeekPositionType',
    'SLODynamic', 'SPBO_PAUSE', 'SPEI_ADAPTATION',
    'SAFTCCITT_ALaw_11kHzStereo', 'ISpeechRecoResult2',
    'DISPID_SGRsAdd', 'DISPID_SVGetAudioOutputs', 'SpeechFormatType',
    'SPEI_RESERVED5', 'DISPID_SpeechLexiconProns',
    'eLEXTYPE_PRIVATE20', 'DISPID_SOTs_NewEnum', 'SP_VISEME_6',
    'ISpeechPhraseAlternates', 'SVP_12', 'DISPID_SLPType',
    'SVEAudioLevel', 'SPEI_UNDEFINED', 'SPDATAKEYLOCATION',
    'DISPID_SRGSetTextSelection', 'ISpeechVoiceStatus', 'SREPrivate',
    'SPWT_DISPLAY', 'DISPID_SVVoice', 'SVP_9', 'DISPID_SBSSeek',
    'eWORDTYPE_ADDED', 'DISPID_SRRPhraseInfo', 'SPWORDLIST',
    'SpSharedRecoContext', 'ISpeechAudio', 'DISPID_SRRTStreamTime',
    'DISPID_SRRDiscardResultInfo', 'ISpeechMemoryStream',
    'DISPID_SPPs_NewEnum', 'SVSFIsXML', 'STSF_FlagCreate',
    'ISpStream', 'SVP_6', 'SpeechGrammarTagDictation',
    'SPCT_DICTATION', 'SPAS_CLOSED', 'DISPID_SPEAudioStreamOffset',
    'SPINTERFERENCE_TOOLOUD', 'eLEXTYPE_RESERVED9',
    'SpeechRuleAttributes', 'SPPS_Unknown',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SRSActive',
    'SVP_10', 'SGDSActive', 'SpeechGrammarTagUnlimitedDictation',
    'SPXRO_Alternates_SML', 'ISpeechGrammarRules',
    'ISpeechResourceLoader', 'SVSFParseSapi', 'SPPROPERTYINFO',
    'SP_VISEME_12', 'DISPID_SOTCId', 'DISPID_SABufferNotifySize',
    'SPSNotOverriden', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPISaveToMemory', 'DISPID_SOTGetAttribute',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVP_2',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SDTPronunciation',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SGRsItem',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRGetFormat', 'SPSUnknown',
    'SPEI_SR_AUDIO_LEVEL', 'eLEXTYPE_PRIVATE9', 'SPEVENTSOURCEINFO',
    'SAFT16kHz16BitStereo', 'SLTUser', 'SPSHORTCUTPAIR',
    'SPAUDIOOPTIONS', 'DISPID_SRGCmdLoadFromMemory',
    'SpSharedRecognizer', 'SpeechGrammarState',
    'DISPID_SRRAudioFormat', 'SpeechTokenKeyUI', 'SRERecognition',
    'DISPID_SLWType', 'SP_VISEME_7', 'SECFIgnoreWidth',
    'DISPID_SpeechBaseStream', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SPRFirstElement', 'ISpNotifySink',
    'DISPID_SRCRequestedUIType', 'SRSEDone', 'SP_VISEME_10',
    'DISPID_SGRsCommitAndSave', 'eLEXTYPE_PRIVATE2',
    'SPRST_NUM_STATES', 'ISpeechCustomStream', 'ISpAudio',
    'SVSFDefault', 'DISPID_SASetState', 'STCInprocServer',
    'SpMMAudioIn', 'SAFTDefault', 'DISPID_SRRTTickCount',
    'SECLowConfidence', 'DISPID_SpeechLexiconWords',
    'IInternetSecurityManager', 'SpPhoneticAlphabetConverter',
    'SPSFunction', 'SAFTCCITT_ALaw_22kHzMono', 'SPRECOCONTEXTSTATUS',
    'SREAudioLevel', 'DISPID_SPEDisplayText', 'DISPID_SRRAlternates',
    'SPPS_Noun', 'SPWORD', 'SPEI_RESERVED3',
    'DISPID_SDKGetStringValue', 'SPRS_INACTIVE', 'DISPID_SPRsCount',
    'DISPID_SMSSetData', 'DISPID_SRCEEndStream',
    'eLEXTYPE_LETTERTOSOUND', 'UINT_PTR', 'SPWAVEFORMATTYPE',
    'ISpeechObjectTokens', 'SRERecoOtherContext',
    'SpeechRegistryLocalMachineRoot', 'ISpRecognizer', 'SPBO_NONE',
    'SAFT22kHz16BitStereo', 'ISpeechWaveFormatEx', 'DISPID_SVEWord',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_RECOGNITION',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPILanguageId',
    'SP_VISEME_9', 'DISPID_SpeechMemoryStream', 'SVP_17',
    'SRERequestUI', 'DISPID_SPRulesCount', 'eLEXTYPE_MORPHOLOGY',
    'IInternetSecurityMgrSite', 'DISPID_SVSpeakStream',
    'SPBOOKMARKOPTIONS', 'DISPID_SVWaitUntilDone', 'SVEPhoneme',
    'DISPID_SPANumberOfElementsInResult',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpXMLRecoResult',
    'SPVPRI_NORMAL', 'SAFTADPCM_8kHzStereo', 'SRTAutopause',
    'eLEXTYPE_RESERVED4', 'SAFTNonStandardFormat',
    'DISPID_SASNonBlockingIO', 'SpeechAudioVolume', 'SPRST_INACTIVE',
    'SpeechCategoryAudioOut', 'Speech_StreamPos_Asap',
    'DISPIDSPTSI_ActiveOffset', 'SPAR_High', 'DISPID_SPCIdToPhone',
    'DISPID_SRRSaveToMemory', 'ISpeechPhoneConverter',
    'SpeechGrammarTagWildcard', 'ISpVoice', 'SVSFNLPSpeakPunc',
    'SDTReplacement', 'DISPID_SGRAttributes', 'SPAS_STOP',
    'DISPID_SpeechObjectTokens', 'SPCATEGORYTYPE',
    'SpInprocRecognizer', 'DISPID_SRCERecognitionForOtherContext',
    'SFTSREngine', 'ISpEventSink', 'DISPID_SVSLastResult',
    'SPPHRASEREPLACEMENT', 'STCRemoteServer',
    'SWPUnknownWordPronounceable', 'SVEEndInputStream',
    'DISPID_SPIRule', 'SBONone', 'DISPID_SGRAddState',
    'SDA_One_Trailing_Space', 'SpeechStreamFileMode',
    'SWPKnownWordPronounceable', 'SRTReSent', 'eLEXTYPE_PRIVATE18',
    'eLEXTYPE_APP', 'SSSPTRelativeToEnd', 'DISPID_SpeechAudioStatus',
    'SVP_0', 'SPVPRI_ALERT', 'DISPID_SRGIsPronounceable',
    'DISPID_SVSInputSentenceLength', 'SpeechAudioFormatGUIDWave',
    'SpeechEngineProperties', 'DISPID_SAFGetWaveFormatEx', 'SVP_20',
    'SDTAll', 'DISPID_SMSAMMHandle', 'SPSERIALIZEDRESULT',
    'SGSExclusive', 'DISPID_SDKEnumValues', 'DISPID_SRAudioInput',
    'ISpeechVoice', 'SPEI_SR_RETAINEDAUDIO', 'ISpRecoContext2',
    'SVSFParseMask', 'DISPID_SVSPhonemeId', 'SVP_8',
    '_ISpeechVoiceEvents', 'DISPID_SpeechPhoneConverter',
    'ISpeechXMLRecoResult', 'SpVoice', 'SpeechAllElements',
    'DISPID_SPPChildren', 'DISPID_SPPValue', 'DISPID_SLPsItem',
    'ISpeechObjectTokenCategory', 'STCInprocHandler', 'ISpDataKey',
    'SVSFParseSsml', 'SASPause', 'DISPID_SGRSRule',
    'SAFT44kHz16BitStereo', 'DISPID_SOTRemove', 'ISpeechRecoGrammar',
    'Speech_Default_Weight', 'DISPID_SDKDeleteValue',
    'SSFMOpenReadWrite', 'ISpeechRecoContext', 'SRTEmulated',
    'ISpeechGrammarRule', 'DISPID_SOTGetStorageFileName',
    'DISPID_SPERequiredConfidence', 'ISpeechFileStream',
    'SAFT24kHz8BitMono', 'DISPID_SPRulesItem', 'DISPID_SVStatus',
    '_RemotableHandle', 'SPEI_PHONEME', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SOTCategory', 'SPPS_Function', 'DISPID_SRCVoice',
    'SSTTWildcard', 'DISPID_SOTDataKey', 'SREPropertyNumChange',
    'eLEXTYPE_USER_SHORTCUT', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechRecoResult2', 'SPVISEMES',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRSNumberOfActiveRules',
    'SP_VISEME_16', 'tagSPPROPERTYINFO', 'SpUnCompressedLexicon',
    'DISPID_SRCResume', 'SPSTREAMFORMATTYPE', 'DISPID_SABIBufferSize',
    'DISPID_SOTMatchesAttributes',
    'ISpeechGrammarRuleStateTransitions', 'SREHypothesis',
    'SpeechPropertyNormalConfidenceThreshold', 'SPPS_Verb',
    'ISpeechRecoResult', 'SRESoundEnd', 'SPEI_RESERVED1',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SVAlertBoundary',
    'STSF_CommonAppData', 'eLEXTYPE_RESERVED7',
    'SAFTNoAssignedFormat', 'DISPID_SGRId', 'DISPID_SFSClose',
    'SpeechLexiconType', 'SAFT12kHz8BitMono',
    'DISPID_SVESentenceBoundary', 'DISPID_SLGetWords',
    'DISPID_SRSCurrentStreamPosition', 'eLEXTYPE_PRIVATE19',
    'DISPID_SDKSetLongValue', 'SpPhraseInfoBuilder',
    'DISPID_SOTRemoveStorageFileName', 'eLEXTYPE_PRIVATE16',
    'DISPID_SABufferInfo', 'SGDSActiveUserDelimited', 'SPSHT_Unknown',
    'DISPID_SVSyncronousSpeakTimeout', 'SpMMAudioEnum',
    'SRESoundStart', 'SPEI_HYPOTHESIS', 'SECNormalConfidence',
    'SASRun', 'DISPID_SpeechObjectToken', 'ISpeechPhraseReplacement',
    'SpeechTokenIdUserLexicon', 'DISPID_SRRSpeakAudio',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechTokenKeyFiles',
    'SPEI_SENTENCE_BOUNDARY', 'SGPronounciation', 'SPCT_COMMAND',
    'DISPID_SPRuleFirstElement', 'DISPID_SPEPronunciation',
    'DISPID_SPEsItem', 'IEnumSpObjectTokens', 'SREPhraseStart',
    'SGRSTTEpsilon', 'DISPID_SOTDisplayUI', 'SAFTGSM610_22kHzMono',
    'SPAO_NONE', 'SPINTERFERENCE_LATENCY_WARNING',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPPEngineConfidence',
    'DISPID_SPRuleId', 'SRTExtendableParse', 'ISpeechPhraseInfo',
    'SINoise', 'SAFT11kHz16BitMono', 'SDKLDefaultLocation', 'SVP_4',
    'eLEXTYPE_PRIVATE10', 'DISPID_SpeechWaveFormatEx', 'SPRECOSTATE',
    'SPWORDTYPE', 'SPSNoun', 'DISPID_SpeechPhraseRule',
    'SpeechAudioFormatGUIDText', 'DISPIDSPTSI_SelectionOffset',
    'SP_VISEME_2', 'SPINTERFERENCE_NONE', 'SVP_15',
    'DISPID_SBSFormat', 'DISPID_SRRGetXMLResult', 'SP_VISEME_20',
    'SPSModifier', 'DISPID_SVSpeak', 'DISPID_SOTCDefault', 'SFTInput',
    'DISPID_SGRSTPropertyName', 'DISPID_SRRTOffsetFromStart',
    'SAFT12kHz16BitStereo', 'eLEXTYPE_RESERVED10',
    'DISPID_SGRSTPropertyId', 'DISPID_SPCLangId', 'SVPOver',
    'SGRSTTTextBuffer', 'DISPID_SDKDeleteKey', 'SAFT48kHz16BitMono',
    'SpeechGrammarRuleStateTransitionType', 'SPWORDPRONOUNCEABLE',
    'SAFT24kHz8BitStereo', 'SPCT_SUB_DICTATION',
    'DISPID_SVGetAudioInputs', 'SPTEXTSELECTIONINFO',
    'DISPID_SVIsUISupported', 'SPEI_RESERVED2', 'SGDSInactive',
    'DISPID_SpeechGrammarRuleStateTransition',
    'ISpPhoneticAlphabetConverter', 'SVSFPersistXML',
    'DISPID_SVAudioOutput', 'ISpeechPhraseElement',
    'DISPID_SpeechRecoContext', 'SPEI_START_INPUT_STREAM',
    'SPEI_VISEME', 'DISPID_SPIGetDisplayAttributes',
    'eLEXTYPE_PRIVATE4', 'SDTAlternates', 'ISpeechPhraseRule',
    'SRSActiveAlways', 'DISPID_SLPsCount',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPEDisplayAttributes',
    'DISPID_SMSALineId', 'DISPID_SGRSTNextState', 'DISPID_SAFType',
    'SPRECOGNIZERSTATUS', 'SPAUDIOBUFFERINFO', 'SINoSignal',
    'DISPID_SVResume', 'DISPID_SpeechPhraseElement',
    'DISPID_SGRsFindRule', 'DISPID_SRGCommit',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPRuleNumberOfElements', 'SDKLLocalMachine',
    'DISPID_SRGSetWordSequenceData', 'SGDisplay',
    'DISPID_SPAs_NewEnum', 'DISPID_SVSInputSentencePosition',
    'DISPID_SLWsItem', 'SWTAdded', 'SPSLMA', 'ISpProperties',
    'SECHighConfidence', 'SITooQuiet', 'SVP_11', 'STCLocalServer',
    'SPEI_END_INPUT_STREAM', 'ISpeechGrammarRuleStateTransition',
    'SPEI_REQUEST_UI', 'SAFT8kHz16BitMono', 'DISPID_SVSVisemeId',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpPhoneConverter',
    'SPEI_TTS_BOOKMARK', 'SRCS_Enabled', 'SpeechGrammarWordType',
    'DISPID_SOTSetId', 'DISPID_SRCERecognition', 'SVEViseme',
    'SPLOADOPTIONS', 'SAFTCCITT_ALaw_8kHzMono', 'SRAInterpreter',
    'DISPID_SpeechFileStream', 'SpeechEmulationCompareFlags',
    'ISpGrammarBuilder', 'Speech_Max_Word_Length', 'SPRST_ACTIVE',
    'SAFTADPCM_22kHzMono', 'SSFMCreate', 'DISPID_SPEEngineConfidence',
    'SPSHT_EMAIL', 'SP_VISEME_3', 'SPBINARYGRAMMAR',
    'SpeechTokenValueCLSID', 'SVEVoiceChange', 'DISPID_SRCEBookmark',
    'SASClosed', 'SRCS_Disabled', 'DISPID_SLWsCount',
    'DISPID_SGRSTsCount', 'SVEPrivate', 'DISPID_SpeechPhraseInfo',
    'DISPID_SRCCreateResultFromMemory', 'SVEWordBoundary',
    'ISpRecoGrammar2', 'DISPID_SRGId', 'DISPID_SVSInputWordLength',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SpeechPhraseBuilder',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SLGetGenerationChange', 'eLEXTYPE_PRIVATE15',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SFSOpen', 'SPEI_WORD_BOUNDARY',
    'DISPID_SCSBaseStream', 'SpeechVoiceSkipTypeSentence',
    'ISpeechObjectToken', 'SpeechRecognizerState',
    'ISpeechBaseStream', 'SpPhoneConverter', 'DISPID_SPRText',
    'DISPID_SRGRecoContext', 'DISPID_SVEStreamStart',
    'DISPID_SpeechGrammarRules', 'DISPID_SRCEStartStream',
    'SGSEnabled', 'SREFalseRecognition', 'SPSEMANTICERRORINFO',
    'DISPID_SPPParent', 'ISpMMSysAudio', 'SPSHORTCUTTYPE',
    'DISPID_SVSInputWordPosition', 'SPFILEMODE',
    'DISPID_SLRemovePronunciation', 'DISPID_SRRAudio',
    'SAFT24kHz16BitMono', 'SpeechDiscardType', 'SVP_14', 'SDTAudio',
    'eLEXTYPE_PRIVATE11', 'DISPID_SRGRules', 'SECFIgnoreKanaType',
    'SpeechWordPronounceable', 'ISpeechPhraseProperties',
    '_ISpeechRecoContextEvents', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpeechTokenShellFolder', 'SpeechUserTraining',
    'DISPID_SVEStreamEnd', 'DISPID_SRStatus', 'SPAS_PAUSE',
    'DISPID_SPRules_NewEnum', 'DISPID_SRCEPhraseStart',
    'SPRECORESULTTIMES', 'DISPID_SPAsCount', 'ISpeechPhraseRules',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SPPId',
    'SPSMF_UPS', 'DISPID_SMSGetData', 'DISPID_SpeechPhraseProperty',
    'SRARoot', 'SGLexicalNoSpecialChars', 'DISPID_SGRSTWeight',
    'SpeechCategoryAudioIn', 'DISPID_SWFEFormatTag',
    'DISPID_SpeechVoiceStatus', 'SREStreamStart',
    'SpInProcRecoContext', 'DISPID_SLWPronunciations',
    'SPEI_RESERVED6', 'SAFT16kHz8BitMono', 'SGSDisabled',
    'DISPID_SRGetPropertyNumber', 'SVF_Stressed', 'SP_VISEME_18',
    'SPFM_NUM_MODES', 'SPFM_CREATE_ALWAYS', 'DISPID_SRCBookmark',
    'DISPID_SWFEExtraData', 'SAFT8kHz8BitStereo',
    'DISPID_SRGCmdLoadFromResource', 'WAVEFORMATEX',
    'DISPID_SRCRetainedAudio', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SpeechObjectTokenCategory', 'ISpeechPhraseAlternate',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SLOStatic', 'SP_VISEME_17',
    'SVP_7', 'SPAUDIOSTATE', 'SpeechVoiceCategoryTTSRate',
    'SPAUDIOSTATUS', 'SpLexicon', 'DISPID_SVGetVoices', 'SPAR_Low',
    'DISPID_SRGDictationLoad', 'ISpSerializeState',
    'DISPID_SAEventHandle', 'SVP_21', 'SREAllEvents', 'SpMMAudioOut',
    'ISpRecognizer2', 'DISPID_SVPause', 'SRAONone',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPARecoResult',
    'DISPID_SPIReplacements', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SDKEnumKeys',
    'DISPID_SOTsCount', 'DISPID_SPACommit', 'SpCompressedLexicon',
    'DISPID_SVPriority', 'DISPID_SPRuleChildren', 'SPPS_SuppressWord',
    'SpeechMicTraining', 'DISPID_SADefaultFormat', 'DISPID_SAFGuid',
    'SPEI_MAX_TTS', 'SP_VISEME_5', 'SAFT22kHz8BitStereo',
    'DISPID_SASState', 'Speech_Max_Pron_Length', 'DISPIDSPRG',
    'DISPID_SRCEFalseRecognition', 'SpeechPropertyResourceUsage',
    'SPRULE', 'ISpRecoContext', 'DISPID_SRRSetTextFeedback',
    'DISPID_SPPName', 'SAFT11kHz8BitMono', 'DISPID_SVEVoiceChange',
    'DISPID_SLWWord', 'SRADefaultToActive', 'SpeechRunState',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechCategoryRecognizers',
    'DISPID_SPIAudioStreamPosition', 'SPDKL_CurrentUser',
    'DISPID_SASFreeBufferSpace', 'SpeechBookmarkOptions',
    'DISPID_SWFEBlockAlign', 'SPPHRASERULE',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SVEBookmark',
    'ISpStreamFormatConverter', 'ISpObjectTokenCategory',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SVVolume',
    'DISPID_SGRName', 'DISPID_SRRRecoContext', 'SVEStartInputStream',
    'SDTDisplayText', 'DISPID_SRGetRecognizers', 'SRAImport',
    'SREStateChange', 'DISPID_SBSRead', 'SAFT44kHz16BitMono',
    'SRSInactive', 'DISPID_SpeechAudioFormat', 'DISPID_SGRsDynamic',
    'SECFEmulateResult', 'DISPID_SpeechPhraseRules',
    'DISPID_SBSWrite', 'DISPID_SRGCmdSetRuleIdState',
    'SPEI_INTERFERENCE', 'SINone', 'ISpPhoneticAlphabetSelection',
    'SAFTExtendedAudioFormat', 'SAFTTrueSpeech_8kHz1BitMono',
    'SpObjectToken', 'SAFTCCITT_uLaw_11kHzMono',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SABIEventBias', 'DISPID_SPIEnginePrivateData',
    'ISpObjectToken', 'SP_VISEME_4', 'SP_VISEME_15', 'SVP_19',
    'ISpStreamFormat', 'SPWORDPRONUNCIATIONLIST', 'SAFT48kHz8BitMono',
    'SDKLCurrentUser', 'SPFM_OPEN_READWRITE',
    'DISPID_SPRDisplayAttributes', 'SpeechPropertyAdaptationOn',
    'SpTextSelectionInformation', 'SPCT_SUB_COMMAND',
    'SpeechInterference', 'DISPID_SpeechRecoResult',
    'SpeechVoiceEvents', 'SPPS_Interjection', 'SpeechVisemeFeature',
    'DISPID_SRCESoundEnd', 'DISPID_SVRate',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechCategoryAppLexicons',
    'DISPID_SRCEventInterests', 'SP_VISEME_19', 'SAFTGSM610_8kHzMono',
    'eLEXTYPE_PRIVATE7', 'DISPID_SPPConfidence', 'DISPID_SGRSTRule',
    'ISpeechTextSelectionInformation', 'SPGS_ENABLED',
    'SpWaveFormatEx', 'SPDKL_CurrentConfig', 'SPAR_Medium',
    'SPPS_RESERVED3', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SRDisplayUI', 'SPSInterjection', 'DISPID_SGRAddResource',
    'DISPIDSPTSI', 'SAFT32kHz8BitStereo', 'SP_VISEME_0',
    'SpeechCategoryRecoProfiles', 'DISPID_SLPPartOfSpeech',
    'SPPHRASEPROPERTY', 'SpeechRegistryUserRoot', 'SPWT_LEXICAL',
    'SREPropertyStringChange', 'DISPID_SpeechPhraseProperties',
    'SPEI_END_SR_STREAM', 'SPGS_EXCLUSIVE', 'eLEXTYPE_PRIVATE5',
    'SVSFVoiceMask', 'SpeechAddRemoveWord', 'DISPID_SpeechRecognizer',
    'SREAdaptation', 'SpeechPropertyHighConfidenceThreshold',
    'SSFMCreateForWrite', 'SAFTADPCM_8kHzMono', 'DISPID_SPEsCount',
    'SRAORetainAudio', 'SPEVENTENUM', 'SPLEXICONTYPE',
    'SPPHRASEELEMENT', 'Speech_StreamPos_RealTime',
    'SPRST_ACTIVE_ALWAYS', 'SpeechPropertyResponseSpeed',
    'SpStreamFormatConverter', 'DISPID_SPERetainedSizeBytes',
    'SASStop', 'DISPID_SPEAudioSizeTime'
]

_check_version('1.1.14', 1622894734.860562)
